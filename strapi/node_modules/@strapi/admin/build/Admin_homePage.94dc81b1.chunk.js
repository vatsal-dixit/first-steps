...
`;var Ve=()=>{const{formatMessage:t}=(0,p.Z)(),{trackUsage:l}=(0,r.rS)();return e.createElement(Ie,{href:"https://cloud.strapi.io",target:"_blank",rel:"noopener noreferrer nofollow",onClick:()=>{l("didClickOnTryStrapiCloudSection")}},e.createElement(m.k,{shadow:"tableShadow",hasRadius:!0,padding:6,background:"neutral0",position:"relative",gap:6},e.createElement(Oe,{backgroundImage:Re,hasRadius:!0,padding:3},e.createElement(We,{width:(0,r.Q1)(32),height:(0,r.Q1)(32),justifyContent:"center",hasRadius:!0,alignItems:"center"},e.createElement("img",{src:Ae,alt:t({id:"app.components.BlockLink.cloud",defaultMessage:"Strapi Cloud"})}))),e.createElement(m.k,{gap:1,direction:"column",alignItems:"start"},e.createElement(m.k,null,e.createElement(k.Z,{fontWeight:"semiBold",variant:"pi"},t({id:"app.components.BlockLink.cloud",defaultMessage:"Strapi Cloud"}))),e.createElement(k.Z,{textColor:"neutral600"},t({id:"app.components.BlockLink.cloud.content",defaultMessage:"A fully composable, and collaborative platform to boost your team velocity."})),e.createElement(u.x,{src:De,position:"absolute",top:0,right:0,as:"img"}))))};const P=d.ZP.a`
  text-decoration: none;
`;var Ge=()=>{const{formatMessage:t}=(0,p.Z)(),{trackUsage:l}=(0,r.rS)(),o=i=>{l(i)};return e.createElement(m.k,{direction:"column",alignItems:"stretch",gap:5},e.createElement(Ve,null),e.createElement(P,{href:"https://strapi.io/resource-center",target:"_blank",rel:"noopener noreferrer nofollow",onClick:()=>o("didClickonReadTheDocumentationSection")},e.createElement(r.Y_,{title:t({id:"global.documentation",defaultMessage:"Documentation"}),subtitle:t({id:"app.components.BlockLink.documentation.content",defaultMessage:"Discover the essential concepts, guides and instructions."}),icon:e.createElement(Be,null),iconBackground:"primary100"})),e.createElement(P,{href:"https://strapi.io/starters",target:"_blank",rel:"noopener noreferrer nofollow",onClick:()=>o("didClickonCodeExampleSection")},e.createElement(r.Y_,{title:t({id:"app.components.BlockLink.code",defaultMessage:"Code example"}),subtitle:t({id:"app.components.BlockLink.code.content",defaultMessage:"Learn by using ready-made starters for your projects."}),icon:e.createElement(je,null),iconBackground:"warning100"})),e.createElement(P,{href:"https://strapi.io/blog/categories/tutorials",target:"_blank",rel:"noopener noreferrer nofollow",onClick:()=>o("didClickonTutorialSection")},e.createElement(r.Y_,{title:t({id:"app.components.BlockLink.tutorial",defaultMessage:"Tutorials"}),subtitle:t({id:"app.components.BlockLink.tutorial.content",defaultMessage:"Follow step-by-step instructions to use and customize Strapi."}),icon:e.createElement(He,null),iconBackground:"secondary100"})),e.createElement(P,{href:"https://strapi.io/blog",target:"_blank",rel:"noopener noreferrer nofollow",onClick:()=>o("didClickonBlogSection")},e.createElement(r.Y_,{title:t({id:"app.components.BlockLink.blog",defaultMessage:"Blog"}),subtitle:t({id:"app.components.BlockLink.blog.content",defaultMessage:"Read the latest news about Strapi and the ecosystem."}),icon:e.createElement(Fe,null),iconBackground:"alternative100"})))};const ze=(()=>window&&window.strapi&&window.strapi.isEE?n(21306).Z:n(83119).Z)(),Ne=(0,d.ZP)(u.x).withConfig({displayName:"HomePage__LogoContainer",componentId:"sc-1md9zz4-0"})(["position:absolute;top:0;right:0;img{width:","rem;}"],150/16),Ue=()=>{const{collectionTypes:t,singleTypes:l,isLoading:o}=(0,$.G)(),{guidedTourState:i,isGuidedTourVisible:c,isSkipped:g}=(0,r.c1)();ze();const C=!Y(i)&&c&&!g,{push:Z}=(0,N.k6)(),v=E=>{E.preventDefault(),Z("/plugins/content-type-builder/content-types/create-content-type")},h=(0,e.useMemo)(()=>{const E=j=>j.filter(O=>O.isDisplayed);return E(t).length>1||E(l).length>0},[t,l]);return o?e.createElement(r.dO,null):e.createElement(U.A,null,e.createElement(T,{id:"HomePage.helmet.title",defaultMessage:"Homepage"},E=>e.createElement(z.q,{title:E[0]})),e.createElement(Q.o,null,e.createElement(Ne,null,e.createElement("img",{alt:"","aria-hidden":!0,src:K})),e.createElement(u.x,{padding:10},e.createElement(F.r,null,e.createElement(B.P,{col:8,s:12},e.createElement(be,{onCreateCT:v,hasCreatedContentType:h}))),e.createElement(F.r,{gap:6},e.createElement(B.P,{col:8,s:12},C?e.createElement(ae,null):e.createElement(Ge,null)),e.createElement(B.P,{col:4,s:12},e.createElement(Ce,null))))))};var Qe=(0,e.memo)(Ue)},83119:function(L,x){const n=()=>null;x.Z=n},96709:function(L,x,n){n.d(x,{A:function(){return S}});var e=n(74512),y=n(8471),p=n(72850);const w=(0,y.ZP)(p.x)`
  display: grid;
  grid-template-columns: ${({hasSideNav:M})=>M?"auto 1fr":"1fr"};
`,H=(0,y.ZP)(p.x)`
  overflow-x: hidden;
`,S=({sideNav:M,children:T})=>(0,e.jsxs)(w,{hasSideNav:!!M,children:[M,(0,e.jsx)(H,{paddingBottom:10,children:T})]})},33904:function(L,x,n){n.d(x,{Z:function(){return p}});var e=n(74512);const y=w=>(0,e.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",width:"1rem",height:"1rem",fill:"none",viewBox:"0 0 24 24",...w,children:(0,e.jsx)("path",{fill:"#161614",d:"M12 0C5.373 0 0 5.501 0 12.288c0 5.43 3.438 10.035 8.206 11.66.6.114.82-.266.82-.59 0-.294-.01-1.262-.016-2.289-3.338.744-4.043-1.45-4.043-1.45-.546-1.42-1.332-1.797-1.332-1.797-1.089-.763.082-.747.082-.747 1.205.086 1.84 1.266 1.84 1.266 1.07 1.878 2.807 1.335 3.491 1.021.108-.794.42-1.336.762-1.643-2.665-.31-5.467-1.364-5.467-6.073 0-1.341.469-2.437 1.236-3.298-.124-.31-.535-1.56.117-3.252 0 0 1.007-.33 3.3 1.26A11.25 11.25 0 0 1 12 5.942c1.02.005 2.047.141 3.006.414 2.29-1.59 3.297-1.26 3.297-1.26.653 1.693.242 2.943.118 3.252.77.86 1.235 1.957 1.235 3.298 0 4.72-2.808 5.76-5.48 6.063.43.382.814 1.13.814 2.276 0 1.644-.014 2.967-.014 3.372 0 .327.216.71.825.59C20.566 22.32 24 17.715 24 12.288 24 5.501 18.627 0 12 0Z"})}),p=y}}]);
