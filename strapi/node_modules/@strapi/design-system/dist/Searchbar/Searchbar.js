...
import { FieldAction as g } from "../Field/FieldAction.js";
const j = e(w)`
  font-size: 0.5rem;
  path {
...
`, J = R(({ name: r, size: s = "M", children: a, value: t = "", onClear: c, clearLabel: d, ...m }, p) => {
  ...
  return o(W, { children: $(I, { name: r, children: [o(z, { children: o(A, { children: a }) }), o(y, { ref: u, value: t, startAction: o(l, { "aria-hidden": !0 }), size: s, endAction: f ? o(g, { label: d, onClick: h, children: o(j, {}) }) : void 0, ...m })] }) });
});
export {
  J as Searchbar
};
