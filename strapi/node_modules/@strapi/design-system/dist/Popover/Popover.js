...
import { useCallbackRef as T, composeEventHandlers as v } from "@strapi/ui-primitives";
...
`, G = ({ source: e, children: s, spacing: n = 0, fullWidth: i = !1, placement: l = "bottom-start", centered: a = !1, onEscapeKeyDown: d, onPointerDownOutside: u, onDismiss: c, onFocusOutside: f, ...E }) => {
  const [m, P] = o.useState(null), b = o.useRef(!1), [R, y] = o.useState(void 0), { x: C, y: D, reference: w, floating: L, strategy: O } = I({
    strategy: "fixed",
  ...
  return Z(l, n ?? (() => {
    ...
    selectorToWatch: `#${k(a)}`,
    skipWhen: !s || !n
  }), z(Q, { ref: l, ...i, children: [e, s && n && r(h, { id: k(a), width: "100%", height: "1px" })] });
}, Q = x(h)`
...
`, me = ({ children: e, source: s, spacing: n, fullWidth: i, placement: l, centered: a, onEscapeKeyDown: d, onPointerDownOutside: u, onDismiss: c, ...f }) => r(_, { children: r(G, { source: s, spacing: n, fullWidth: i, placement: l, centered: a, onEscapeKeyDown: d, onPointerDownOutside: u, onDismiss: c, children: r(J, { ...f, children: e }) }) });
export {
  G as Content,
  fe as POPOVER_PLACEMENTS,
  me as Popover,
  J as Scrolling
};
